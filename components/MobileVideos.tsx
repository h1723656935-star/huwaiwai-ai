              ...
              <div className={`relative ${video.orientation === 'vertical' ? 'aspect-[9/16]' : 'aspect-video'}`}>
                {video.thumbnail ? (
                  <img
                    ...
                    onError={(e) => { (e.target as HTMLImageElement).src = 'data:image/svg+xml,%3Csvg xmlns=%27http://www.w3.org/2000/svg%27 width=%27400%27 height=%27300%27%3E%3Crect width=%27100%25%27 height=%27100%25%27 fill=%27%231A1628%27/%3E%3Ctext x=%2750%25%27 y=%2750%25%27 dominant-baseline=%27middle%27 text-anchor=%27middle%27 fill=%27%235E3D8A%27 font-size=%2714%27%3E封面加载失败%3C/text%3E%3C/svg%3E'; }}
                  />
                ) : (
